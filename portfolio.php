...
<head>
	...
	<title>w+a</title>
	<meta name="description" content="portfolio Manuel del Pozo">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta prefix="og: http://ogp.me/ns#" property="og:title" content="Welcome to my web portfolio" />
    <meta prefix="og: http://ogp.me/ns#" property="og:image" content="http://www.manueldelpozo.info/icons/favicon.png" />
    <meta prefix="og: http://ogp.me/ns#" property="og:url" content="http://www.manueldelpozo.info/" />
  ...
  $('video').on('ended',function(){
      $("#pfinal").empty();
      $("#pfinal").html('<a class="btn btn-default" role="button" align="center" href="mailto:mdp.webdeveloper@gmail.com?cc=mndelpozo@gmail.com&subject=I%20would%20like%20to%20hire%20you&body=Hello,%0D%0A%0D%0AI am really interested in your profile." target="_top" id="hire-me">HIRE ME</a><a class="btn btn-default" role="button" align="center" href="resume.pdf" download="cv_ManueldelPozo" target="_top" id="resume">RESUME</a>');
  });
...
<div class="container-fluid">
	 <div class="row-fluid">
      	...
      	<div class="col-md-4 col-sm-6 col-xs-8 center-box trans">
              ...
              <div class="col-md-12 col-xs-12 text-center lead green-a" id="title"><samp>://<strong class="back2">w+a</strong>/<span class="back1"><?php echo $url; ?></span>/</samp></div>
                ...
                <div class="col-md-12 col-xs-12 squarebrackets text-center" id="body" style=" padding-bottom: 20px; padding-top: 20px;">
                    ...
                    <div class="col-md-12 col-xs-12 trans" id="brackets">
                      <form id='target' action='portfolio.php' method="post">
                            ...
                            <?php 
                              if( $pfinal_text ) {
                                if( $pfinal_text == 'map' )
                                  ...
                                  echo '<a class="btn btn-default" role="button" align="center" href="resume.pdf" download="cv_ManueldelPozo" target="_top" id="resume">RESUME</a>';
                                }
                              } else if( $pfinal_list ) {
                 ...
                 <div class="col-md-12 col-xs-12 text-center lead" id="footer">
                      <span><img src='icons/favicon.png'/></span>&nbsp;&nbsp;  <strong> <u>M</u>anuel del Pozo</strong> || <nobr>w+a</nobr> 
                      <form action="index_submit" action='portfolio.php' method="post">
